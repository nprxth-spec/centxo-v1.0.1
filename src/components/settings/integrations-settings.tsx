    ...
    return (
        <div className="space-y-6">
            ...
            <div className="glass-card p-6">
                <h3 className="text-section-title mb-6">{t('settings.integrations.connectedAccounts', 'Connected Accounts')}</h3>
                ...
                {loadingAccounts ? (
                    ...
                    <div className="space-y-4">
                        {availableProviders.map((provider) => {
                            ...
                            return (
                                <div key={provider.id} className="flex items-center justify-between p-4 border border-border rounded-lg hover:shadow-sm transition-shadow">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            {provider.connected && connectedAccount ? (
                                                ...
                                                <p className="text-sm text-muted-foreground">{t('settings.integrations.notConnected', 'Not connected')}</p>
                                            )}
                                        </div>
                                    </div>
