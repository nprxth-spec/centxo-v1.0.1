...
export interface AccountsTabProps {
    ...
    searchQuery?: string;
    hasTeamMembers?: boolean | null;
}

export function AccountsTab({ selectedIds, onSelectionChange, refreshTrigger = 0, searchQuery = '', hasTeamMembers = true }: AccountsTabProps) {
    ...
    // Fetch real data from Facebook on mount (use cache to save quota); manual refresh uses refreshTrigger
    ...
    if (loading && accounts.length === 0) {
        ...
        return (
            <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 overflow-hidden flex-1 flex flex-col min-h-0 rounded-lg">
                ...
                <div className="overflow-auto flex-1 [&>div]:overflow-visible">
                    <Table className="min-w-max">
                        ...
                        <TableBody className="divide-y divide-gray-200 dark:divide-zinc-800 border-b border-gray-200 dark:border-zinc-800">
                            ...
                            {/* Unconnected Account Alert Row */}
                            {hasTeamMembers === false && (
                                <TableRow>
                                    <TableCell colSpan={9} className="p-4">
                                        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 flex flex-col items-center justify-center text-center gap-4">
                                            <div className="p-3 bg-blue-100 dark:bg-blue-800/30 rounded-full">
                                                <Building2 className="h-8 w-8 text-blue-600 dark:text-blue-400" />
                                            </div>
                                            <div className="max-w-md space-y-2">
                                                <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-300">Connect your Facebook Account</h3>
                            ...
                            {accounts.length === 0 && !loading && hasTeamMembers !== false && (
                                <TableRow>
