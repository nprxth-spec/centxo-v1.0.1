...
export const PLANS: Record<PlanId, Plan> = {
  FREE: {
    ...
    features: [
      ...
      { key: 'plans.features.inbox', fallback: 'Inbox (Messenger)', included: false },
  ...
  PLUS: {
    ...
    features: [
      ...
      { key: 'plans.features.inbox', fallback: 'Inbox (Messenger)', included: true, badge: 'NEW' },
  ...
  PRO: {
    ...
    features: [
      ...
      { key: 'plans.features.inbox', fallback: 'Inbox (Messenger)', included: true },
      { key: 'plans.features.googleSheets', fallback: 'Google Sheets export', included: true },
