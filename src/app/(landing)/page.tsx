                ...
                <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            <Link href="/login">
                                <Button size="lg" className="h-12 px-8 rounded-xl text-base font-semibold">
                                    {t('landing.cta.start')} <ArrowRight className="ml-2 h-4 w-4" />
                                </Button>
                            </Link>
                            <Button size="lg" variant="outline" onClick={scrollToFeatures} className="h-12 px-8 rounded-xl text-base font-medium hover:bg-muted/50">
                    ...
                    <motion.div
                        ...
                        className="mt-10"
                    >
                        <div className="rounded-xl border border-border/60 bg-card/80 backdrop-blur-sm p-5 shadow-lg overflow-hidden">
                            ...
                            <div className="grid grid-cols-3 gap-3 mb-4">
                                <div className="p-3 rounded-xl bg-background/80 dark:bg-background/50 border border-border/50">
                            ...
                            <div className="h-36 rounded-xl bg-background/50 dark:bg-background/30 border border-border/50 p-3 flex items-end justify-between gap-1">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {features.map((feat, i) => (
                            <motion.div
                                ...
                                className={`group relative overflow-hidden rounded-xl border bg-gradient-to-br ${feat.accent} p-4 shadow-sm hover:shadow-md transition-all`}
                            >
            ...
            <section className="relative py-12 md:py-16">
                <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6">
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/15 via-primary/10 to-violet-500/10 border border-primary/20 px-6 py-10 text-center"
                    >
                        <div className="relative">
                            ...
                            <Link href="/login">
                                <Button size="lg" className="h-12 px-10 rounded-xl text-base font-semibold">
                                    {t('landing.cta.start')} <ArrowRight className="ml-2 h-4 w-4" />
                                </Button>
                            </Link>
                        </div>
