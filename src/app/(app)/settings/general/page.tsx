...
export default function SettingsGeneralPage() {
    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 max-w-4xl mx-auto space-y-8">
            {/* Header */}
            <div>
                <h1 className="text-page-title mb-2">{t('settings.general', 'General Settings')}</h1>
                <p className="text-muted-foreground">{t('settings.generalSubtitle', 'Manage your profile and security preferences')}</p>
            </div>

            {/* Profile Section */}
            <div className="glass-card p-6">
                <h2 className="text-section-title mb-6">{t('settings.profile')}</h2>
                <div className="space-y-6">
                    <div>
                        <Label className="text-label mb-2 block">{t('settings.name')}</Label>
                        <Input
                            value={formData.name}
                    ...
                    <div>
                        <Label className="text-label mb-2 block">{t('settings.email')}</Label>
                        <Input
                            type="email"
            ...
            {/* Security Section */}
            <div className="glass-card p-6">
                <h2 className="text-section-title mb-6">Security Settings</h2>
                <div className="space-y-6">
                    <div>
            ...
            <div className="bg-card rounded-lg border border-destructive/30 p-6">
                <h2 className="text-section-title mb-6">Danger Zone</h2>
                <div className="space-y-6">
